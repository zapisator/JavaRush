...
public class ServiceLocator {
    ...
    /**
     * First, check for a service object in the cache If a service object is not in the cache,
     * perform a lookup using the JNDI initial context and get the service object. Add it to the
