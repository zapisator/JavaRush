...
//        software.addNewVersion(1, "Should not be removed.");
//        software.addNewVersion(5, "Should not be removed.");
//        software.addNewVersion(2, "Should be removed.");
//        software.addNewVersion(4, "Should be removed.");
//        software.addNewVersion(3, "Should be removed.");
//        software.rollback(2);
//        software.getVersionHistoryMap().entrySet().forEach(System.out::println);
        int n = 3;
